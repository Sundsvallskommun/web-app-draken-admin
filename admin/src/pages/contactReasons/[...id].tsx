import { EditResourceContactReason } from '@components/edit-resource/edit-resource-contact-reason.component';
...
export const EditContactReason: React.FC = () => {
      ...
      >
        <FormProvider {...form}>
          <form className="flex flex-row gap-32 justify-between grow flex-wrap" onSubmit={handleSubmit(onSubmit)}>
            ...
            <EditResourceContactReason isNew={isNew} />
          </form>
        </FormProvider>
      </EditLayout>;
};
...
export default EditContactReason;
