  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex gap-3 border-t pt-6">
        <Button onClick={() => { toast.success(`${isNew ? 'Skapade' : 'Sparade'} schema "${name}" (skrivning ej kopplad ännu).`); router.push('/poc/jsonSchemas'); }}>
          {isNew ? 'Skapa' : 'Spara ändringar'}
        </Button>
        <Button variant="outline" onClick={() => router.push('/poc/jsonSchemas')}>
          Avbryt
        </Button>
      </div>
    </div>
