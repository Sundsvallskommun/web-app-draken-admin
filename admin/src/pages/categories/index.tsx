...
export const Categories: React.FC = () => {
  ...
  const properties = ['name', 'displayName', 'sortOrder', 'namespace', 'createdAt', 'updatedAt'];
  ...
  const dataWithCompositeId = data?.map((category) => ({
    ...category,
    editId: `${category.namespace}/${category.id}`,
  }));
