        ...
        <CardElevated>
          <Main>
            <CenterDiv className="py-24 px-8">
              ...
              : <>
                  <h1 className="text-center text-h2-sm lg:text-h2-lg mb">Draken</h1>
                  <Divider className="w-full" />
                  <div className="flex flex-col desktop:flex-col gap-56 w-full desktop:w-fit px-80 pb-[10.4rem] pt-80 items-center">
                    <Button data-cy="login-button" variant="primary" size="lg" onClick={() => onLogin()} ref={initalFocus}>
                      {capitalize(t('common:login'))}
                    </Button>
                    <span className='text-small'>{t('login:login_problem')}</span>
                  </div>
